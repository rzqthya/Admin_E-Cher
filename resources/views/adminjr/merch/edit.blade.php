        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('admin.voc.klaim') }}"> Daftar Voucher</a>
                        <a class="collapse-item" href="{{ route('admin.voc.klaim') }}">Check Klaim Voucher</a>
                        <a class="collapse-item" href="{{ route('adminjr.voc.berhasil') }}">Voucher Berhasil Klaim</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.merch.update', ['id' => $merchants->id]) }}"
                                method="POST">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                    <label for="example-text-input" class="col-form-label">Nama Merchant</label>
                                    <input class="form-control mb-4" type="text" id="nama_merchant"
                                        name="nama_merchant" value="{{ $merchants->nama_merchant }}">
                                </div>
                                <div class="form-group">
