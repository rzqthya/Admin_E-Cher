...
<head>
    ...
    <title>Admin JR - Tambah Voucher</title>
                        ...
                        <div class="card-body">
                            <form action="{{ route('voucher.store') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control mb-4" id="nama_voucher" name="nama_voucher"
                                        type="text" placeholder="Nama Voucher">
                                </div>
                                <div class="form-group">
                                    <label for="example-text-input" class="col-form-label">Deskripsi Voucher</label>
                                    <input class="form-control mb-4" id="deskripsi_voucher" name="deskripsi_voucher"
                                        type="text" placeholder="Deskripsi Voucher">
                                </div>
                                <div class="form-group">
                                    <label for="datetime_input" class="col-form-label">Masa Berlaku</label>
                                    <input class="form-control mb-4" id="masa_berlaku" name="masa_berlaku"
                                        type="datetime-local">
                                </div>
                                <div class="form-group">
