...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('voucher.update', ['voucher' => $vouchers->id]) }}" method="POST" >
                @csrf
                @method('PUT')
                
                <div class="form-group">
                    <label for="example-text-input" class="col-form-label">Nama Voucher</label>
                    <input class="form-control mb-4" type="text" id="voucher" name="voucher" value="{{ $vouchers->voucher }}">
                </div>
                <div class="form-group">
                    <label class="col-form-label">Deskripsi Voucher</label>
                    <input class="form-control mb-4" type="text" id="deskripsi" name="deskripsi" value="{{ $vouchers->deskripsi }}">
                </div>
                <div class="form-group">
                    <label class="col-form-label">Masa Berlaku</label>
                    <input class="form-control mb-4" type="datetime-local" id="masaBerlaku" name="masaBerlaku" value="{{ $vouchers->masaBerlaku }}">
                </div>
                <div class="form-group">
